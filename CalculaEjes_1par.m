function [d_A_final,d_E1_final,d_E2_final,d_B_final] = CalculaEjes_1par(Y,Fr,Ft,T,m,Sut,d,Asup,bsup,Conductoras,Conducidas)
    %Cálculo de esfuerzos
    %Plano xy
    Rby=(Fr*((2/3)*Y/2))/((2/3)*Y);                                         %Momentos con respecto al punto A
    Ray=Fr-Rby;                                                             %Fuerzas en y
    %Plano xz
    Rbz=(Ft*((2/3)*Y/2))/((2/3)*Y);                                         %Momentos con respecto al punto A
    ...
    %PUNTO A (entrada eje 1)//PUNTO B' (salida eje 2)
    %Momento torsor
    ...
    %PUNTO E1 (punto medio eje 1)//PUNTO E2 (punto medio eje 2)
    %Momento flector
    sigma_Mf_E=(32*Me)/pi;
    ...
    %del engranaje de entrada (Etapa 1)
    ...
    elseif m==6 & Conductoras>=24 & Conductoras<=40 & d_E_final<=25
        ...
        f48=msgbox({'El diámetro requerido para el eje es mayor que el diámetro interior del engranaje de entrada normalizado que ha sido seleccionado.';' ';...
    ...
    %Comprobar que el diámetro normalizado coincide con el diámetro interior 
    %del engranaje de salida (Etapa 2)
    ...
    elseif m==6 & Conducidas>=24 & Conducidas<=40 & d_E_final<=25
        ...
        f49=msgbox({'El diámetro requerido para el eje es mayor que el diámetro interior del engranaje de salida normalizado que ha sido seleccionado.';' ';...
            'Pruebe a modificar alguno de los siguientes datos introducidos:';...
            '1. Seleccionar otro material para los ejes.';...
            '2. Disminuir la dimensión Y de la caja.';...
            '3. Disminuir la potencia a transmitir.';...
    ...
    %PUNTO B (final eje 1)//PUNTO A' (inicio eje 2)
    %Cortante
